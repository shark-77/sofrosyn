    ...
    <>
        <div class="section_1">
            <div class="left_shape">
                <svg width="120" height="160" viewBox="0 0 41 141" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M40.1357 140.96H-102.768C8.84093 131.122 39.0049 42.8638 40.1357 0.176331V140.96Z" fill="#CEDBFD"/>
                </svg>             
            </div>
            <div class="rounded_design">
                <svg width="290" height="290" viewBox="0 0 290 290" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="144.856" cy="144.936" r="35.62" stroke="#CEDBFD" stroke-width="9.32905"/>
                    <circle cx="144.856" cy="144.936" r="70.392" stroke="#CEDBFD" stroke-width="9.32905"/>
                    <circle cx="144.856" cy="144.936" r="107.708" stroke="#CEDBFD" stroke-width="9.32905"/>
                    <circle cx="144.856" cy="144.936" r="139.936" stroke="#CEDBFD" stroke-width="9.32905"/>
                </svg>                
            </div>
            <div class="hh12">
                <h1>We create execptional<br />digital products</h1>         
            </div>
            <div class="right-shape_sectxxx">
                <svg width="281" height="785" viewBox="0 0 281 785" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.125732 486.122V339.826C124.372 347.882 145.15 438.629 146.846 486.122H0.125732Z" fill="#CEDBFD"/>
                    ...
                    <mask id="mask0_120_1933" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="192" width="297" height="148">
                        <rect x="0.125732" y="192.681" width="295.985" height="146.721" fill="#C4C4C4" />
                    </mask>
                    <g mask="url(#mask0_120_1933)">
                        <path d="M-280.775 358.754L248.339 -163.975" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-24.4768 618.183L504.638 95.4535" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-255.146 384.697L273.969 -138.033" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M1.15308 644.126L530.268 121.396" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-229.516 410.64L299.599 -112.09" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M26.783 670.069L555.898 147.339" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-203.886 436.583L325.229 -86.1468" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M52.4128 696.012L581.527 173.282" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-178.256 462.526L350.859 -60.2039" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M78.0426 721.955L607.157 199.225" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-152.626 488.469L376.488 -34.2611" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M103.672 747.898L632.787 225.168" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-126.996 514.412L402.118 -8.3182" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M129.302 773.841L658.417 251.111" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-101.366 540.355L427.748 17.6247" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M154.932 799.784L684.047 277.054" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-75.7365 566.298L453.378 43.5677" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M180.562 825.727L709.677 302.997" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M-50.1067 592.24L479.008 69.5105" stroke="#CEDBFD" stroke-width="9.32905"/>
                        <path d="M206.192 851.67L735.306 328.94" stroke="#CEDBFD" stroke-width="9.32905"/>
                    </g>
                </svg>             
            </div>
            <div class="btn-div">
                <div class="btn-section-1">
                    <a href="https://pricing.co">
                        <button class="btn-1">Get started</button>
                    </a>
                    <a href="Jupita.html#pricing">
                        <button class="btn-2">See plans</button>
                    </a>
                </div>
            </div>     
        </div>
