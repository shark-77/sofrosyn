            ...
            <div className="frf-xxx">
                <svg className="photo-row" width="100" height="101" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g mask="url(#mask0_120_2573)">
                        ...
                        <path d="M24 61C44.4576 85.8478 56.0694 85.2619 77 61" stroke="black" strokeWidth="5"/>
                        <path d="M21 63.5L27 58.5" stroke="black" strokeWidth="6"/>
                        <path d="M80 63L74 58" stroke="black" strokeWidth="6"/>
                    </g>
                </svg> 
                <p>
                    5.
