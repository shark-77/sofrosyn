    ...
    <>
        <div className="footer_area">
            <div className="foot_links">
                <div id="footer-links">
                    <h1>Social</h1>
                    <a href="https://github.com/Sofrosyne-LLC">Github</a>
                </div>
                <div id="footer-links">
                    <h1>Support</h1>
                    <a href="#">Contact us</a>
                ...
                <div className="foot-txt">
                    <h1>Sofrosyne-llc is headquartered in
                        <br /> Nigeria
                        <br /><br />
                        <span className="little-foot_txt">©2023 Sofrosyne-LLC, All rights reserved</span>
                    </h1>
                </div>
            </div>

            <div className="footer_pic">
                    <rect x="2" width="607" height="912" fill="#000000"/>
                <svg width="129.5%" height="800" viewBox="0 0 500 798" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M298 442C298 360.262 364.262 294 446 294H594V911.5H298L298 442Z" fill="#ffffff"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M593.488 159.15C593.827 155.143 594 151.091 594 147C594 142.909 593.827 138.857 593.488 134.85V0H443.535L443.542 0.00741072C443.029 0.00247412 442.515 0 442 0C358.053 0 290 65.8141 290 147C290 228.186 358.053 294 442 294C521.485 294 586.721 234.996 593.431 159.808L593.488 159.869V159.15Z" fill="grey"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M298.414 589.701L296.719 446.336L296.711 446.343C296.711 445.852 296.707 445.36 296.701 444.868C295.752 364.609 229.13 300.325 147.896 301.286C66.6616 302.247 1.57786 368.088 2.52706 448.347C3.4258 524.34 63.2023 586.012 138.511 591.537L138.451 591.592L139.17 591.584C143.183 591.861 147.239 591.978 151.333 591.93C155.427 591.881 159.479 591.668 163.484 591.296L298.414 589.701Z" fill="grey"/>
                    <path d="M290 153C290 234.738 223.738 301 142 301L1.00003 301L1 -5.2524e-06L290 -3.05176e-05L290 153Z" fill="white"/>
